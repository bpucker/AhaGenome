...
__usage__ = """
				...
				bug reports and feature requests: boas.pucker@rub.de
				"""
...
def main( arguments ):
	...
	if '--k' in arguments:
		kmer_len = int( arguments[ arguments.index( '--k' )+1 ] )
	else:
		kmer_len = 10000	#lenght of in silico marker sequences
	...
	word_size = 50	#word size for BLAST of in silico markers
	match_sim_cutoff = 0.8	#minimal similarity required to keep BLAST hit
	match_len_cutoff = kmer_len*0.8	#minimal alignment length required to keep BLAST hit
